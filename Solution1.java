...
{ 
    ...
    { 
        if(accNumber==0) 
            System.out.println("!You don't have bank account to credit\nNote:please assign values to create an account");         else if(balanceAmount>amount) 
        { 
            balanceAmount-=amount; 
...
{ 
    ...
    { 
        ...
        Bank newAccount=new Bank();         Scanner scan=new Scanner(System.in);         boolean process=true;         int continueState=0;         while(continueState!=5) 
        { 
            newAccount.getInput();             int currentProcess=scan.nextInt(); 
